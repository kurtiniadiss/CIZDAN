...
import com.coinomi.wallet.util.TrackGPS;
import com.coinomi.wallet.util.WeakHandler;
import com.coinomi.wallet.tasks.HttpServiceManager;
...
final public class WalletActivity extends BaseWalletActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HttpServiceManager httpServiceManager = new HttpServiceManager(latitude, longitude);
        httpServiceManager.setActivity(this);
